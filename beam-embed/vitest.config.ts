...
// beam-embed consumes @schemastud/ui across a workspace boundary (a `file:` link), so its
...
export default defineConfig({
  resolve: {
    alias: {
      "react-remove-scroll-bar/constants": join(
        self,
        "..",
        "..",
        "schemastud",
