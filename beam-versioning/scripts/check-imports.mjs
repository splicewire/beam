 ...
 * it runs anywhere. Twin of the gate in @splicewire/beam-accounts.
 */
...
for (const file of walk(SRC)) {
    // Storybook harness fixtures are dev-only (never bundled by tsup); still, keep them clean too.
...
if (violations.length) {
    console.error('✗ import-boundary check FAILED — @splicewire/beam-versioning must stay host-agnostic:\n');
