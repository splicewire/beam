 ...
 */
/**
 * The collapsed rail's destinations as one consistent stroke-icon set (lucide geometry, inlined so
 * the story imports no icon library) — not placeholder letters and an emoji.
 */
const RAIL_ICONS = [
    {
        label: 'Dashboard',
