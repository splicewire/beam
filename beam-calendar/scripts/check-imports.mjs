 ...
 * (plain Node, no eslint). Twin of the gate in @splicewire/beam-workflows.
 */
...
if (violations.length) {
    console.error('✗ import-boundary check FAILED — @splicewire/beam-calendar must stay host-agnostic + foundation-only:\n');
